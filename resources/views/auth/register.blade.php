...
@section('title', 'Register | goodstack')
        ...
        <div class="container py-4">
            <div class="row justify-content-center">
                <div class="col-lg-6 d-none d-lg-block">
                    ...
                    <span class="text-wh">Register with your email & phone number to login using otp</span>
                </div>
                <div class="col-lg-6">
                    <div class="card" style="max-width: 500px; margin: auto;">
                        <div class="card-header text-center my-card">{{ __('Register on goodstack') }}</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-form-label text-md-right">{{ __('Username') }}
                                </label>
